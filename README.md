...
* [expressively-mocked-fetch](https://github.com/TimDaub/expressively-mocked-fetch) - Create local fake HTTP responses using a nodejs `child_process` and express.js.
