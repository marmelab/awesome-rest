...
* [Foglift Scan API](https://foglift.io/developers) - Free REST API to analyze any website's SEO, performance, security, and AI search readiness. Returns JSON with scores and issues.
