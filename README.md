...
* [spring-rest-service](https://github.com/yusufcakmak/spring-rest-service) - This example project shows you how to build a REST Service with Spring MVC and Hibernate.
